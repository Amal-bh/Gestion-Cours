...
<head>
  ...
  <title>Contact - Gestion des Cours</title>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs" data-aos="fade-in">
      <div class="container">
        ...
        <p> Notre mission est de rendre l'éducation accessible, n'hesiter pas à nous contacter pour plus d'information. </p>
      </div>
    </div><!-- End Breadcrumbs -->
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Adresse:</h4>
                <p> A108 cité el Nouer Sousse, Numero 1254
              Tunisie </p>
              </div>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="my-3">
                ...
                <div class="sent-message">Nous avons bien recu votre message. Merci!</div>
              </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>Gestion Cours</h3>
            <p>
              A108 cité el Nouer <br>
              Sousse, Numero 1254 <br>
              Tunisie <br><br>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Filiere</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Evenements</a></li>
            </ul>
          </div>
